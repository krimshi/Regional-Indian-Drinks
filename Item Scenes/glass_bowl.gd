...
func _physics_process(delta: float) -> void:
	if is_held and camera_node:
		...
		# 🎯 NEW: This block runs exactly ONCE the moment you grab the item
		if not was_held:
			was_held = true 
...
# ---------------------------------------------------------
# 🎯 NEW BRIDGE FUNCTION FOR THE STRAINER ZONE
# ---------------------------------------------------------

# The Kitchen Counter Square Drop Zone calls this when the bowl is placed safely!
